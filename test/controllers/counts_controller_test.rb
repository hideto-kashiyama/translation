...
class CountsControllerTest < ActionController::TestCase
  ...
  test "should create count" do
    assert_difference('Count.count') do
      post :create, count: { chrcnt: @count.chrcnt, dt: @count.dt, kubun: @count.kubun, user_id: @count.user_id }
    end
  ...
  test "should update count" do
    patch :update, id: @count, count: { chrcnt: @count.chrcnt, dt: @count.dt, kubun: @count.kubun, user_id: @count.user_id }
    assert_redirected_to count_path(assigns(:count))
  end
